...
# Usage
After starting the application, visit https://ss.scanservices.in in your browser. Users can now register for a new account or log in using existing credentials.
